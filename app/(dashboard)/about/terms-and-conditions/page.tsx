    ...
    <div className='container mt-5'>
      <div className='mx-auto rounded-lg border border-k-default/40 p-20 shadow-lg'>
        ...
        <section className='mb-6'>
          ...
          <p className='text-gray-400'>
            Você concorda em não se envolver em nenhuma das seguintes atividades
            proibidas:
          </p>
          <ul className='text-gray-400 list-inside list-disc'>
            <li>
              Copiar, distribuir ou divulgar qualquer parte do Site em qualquer
              meio, incluindo “scraping” automatizado ou não automatizado.
            </li>
            <li>
              Usar qualquer sistema automatizado, como “robôs” ou “spiders”,
              para acessar o Site de maneira que envie mais solicitações para
              nossos servidores do que um humano pode razoavelmente produzir no
              mesmo período de tempo usando um navegador da web convencional.
            </li>
            <li>
              Transmitir spam, correntes ou outras mensagens não solicitadas.
            </li>
            <li>
              Interferir ou comprometer a integridade ou a segurança do sistema.
            </li>
        ...
        <section className='mb-6'>
          ...
          <p className='text-gray-400'>
            Se você optar por comprar ou acessar nossos produtos e serviços
            pagos, poderá ser necessário concordar com Termos Específicos que
            regem o uso desses produtos e serviços. Esses termos prevalecerão em
            caso de conflito com este Contrato.
          </p>
          <h3 className='text-cyan-300 mb-2 text-xl font-semibold'>
          ...
          <p className='text-gray-400'>
            ...
            prévio de 30 dias sobre o término ou não renovação.
          </p>
          <h3 className='text-cyan-300 mb-2 text-xl font-semibold'>
            3.3. Reembolsos
          </h3>
