...
export function TaxesCard({
  ...
  const totalTaxes =
    Number(dashboardTaxes.invoicing) +
    Number(dashboardTaxes.checkout) +
    Number(dashboardTaxes.gateway)
          ...
          <CardHeader className='flex h-28 w-80 flex-col justify-between md:w-full'>
            <div className='mt-5 flex flex-col items-center justify-between gap-3 lg:flex-col'>
              ...
              {isLoadingShopifyDashboardData ? (
                ...
                <hr className='h-[0.125rem] w-full bg-[#bd2130]' />
              )}
            </div>
          </CardHeader>
          <CardContent className='flex w-full flex-row flex-wrap items-center justify-between'>
            ...
            {isLoadingShopifyDashboardData ? (
              ...
              <>
                <div className='flex w-full items-center justify-between'>
                  <div className='flex items-center gap-2'>
                    <SwitchCards
                      ...
                      onCheckedChange={() => toggleIncludeTaxes()}
                    />
                    <span>Impostos</span>
                  </div>
                  <span className='font-bold'>
                ...
                <div className='flex w-full items-center justify-between'>
                  <div className='flex items-center gap-2'>
                    <SwitchCards
                      checked={includeCheckoutCosts}
                      onCheckedChange={() => toggleIncludeCheckoutCosts()}
                    />
                ...
                <div className='flex w-full items-center justify-between'>
                  <div className='flex items-center gap-2'>
                    <SwitchCards
                      checked={includePaymentGatewayCosts}
                      onCheckedChange={() => toggleIncludePaymentGatewayCosts()}
                    />
